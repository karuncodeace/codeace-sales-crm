...
function LoginContent() {
  ...
  return (
    <div className={`flex min-h-screen ${theme === "dark" ? "bg-[#171717]" : "bg-[#F6F6F6]"}`}>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-600 via-orange-500 to-orange-700 relative overflow-hidden rounded-tr-[240px] rounded-br-[240px]">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
          ...
          <p className="text-lg text-white/80 text-center max-w-md leading-relaxed">
            Upgrade your sales workflow with a next-generation CRM designed for precision and performance
          </p>
        </div>
      </div>
