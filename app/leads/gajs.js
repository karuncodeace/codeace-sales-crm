...
<div className="flex flex-col">
  <div className="-m-1.5 ">
    <div className=" min-w-full inline-block ">
      <div className=" bg-white border border-gray-200 rounded-xl shadow-2xs overflow-x-hidden ">
        {/* Header */}
          ...
          <div className="flex  gap-2 w-full md:w-auto">
            ...
            <div className="relative w-full md:w-80  flex items-center border border-gray-200 rounded-[10px] pl-4">
              ...
              <input
                ...
                className="w-full  pl-2 pr-4 text-sm  focus:outline-none focus:outline-none"
              />
            </div>
            ...
            <div className="flex items-start gap-4 ">
              {kanbanStatuses.map((status) => {
                ...
                return (
                  <div
                    key={status}
                    className="flex min-w-[350px] flex-col r bg-white p-4"
                  >
                    <div
                      className={`flex items-center justify-between rounded-l-sm p-2 ${
                    ...
                    <div className="mt-4 space-y-3">
                      {groupedLeads[status] && groupedLeads[status].length > 0 ? (
                        groupedLeads[status].map((lead) => (
                          <div
                            key={lead.id}
                            className="rounded-lg border border-gray-200 bg-white p-3 shadow-2xs"
                          >
